  ...
  methods: {
    init: function init(data) {
      ...
      this.$nextTick(function () {
        this.swiper = new _swiper2.default('.wrap-swiper-nav', {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7fa4e2da_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(479);
...
/* scopeId */
var __vue_scopeId__ = "data-v-7fa4e2da"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7fa4e2da_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7fa4e2da_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "packages\\swiperNav\\src\\main.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7fa4e2da", Component.options)
  } else {
    hotAPI.reload("data-v-7fa4e2da", Component.options)
  }
...
var update = add("39383d69", content, false, {});
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("65d1e78c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-7fa4e2da\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./main.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-7fa4e2da\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./main.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "/**\n * Swiper 4.5.0\n * Most modern mobile touch slider and framework with hardware accelerated transitions\n * http://www.idangero.us/swiper/\n *\n * Copyright 2014-2019 Vladimir Kharlampidi\n *\n * Released under the MIT License\n *\n * Released on: February 22, 2019\n */\n.swiper-container[data-v-7fa4e2da]{margin:0 auto;position:relative;overflow:hidden;list-style:none;padding:0;z-index:1\n}\n.swiper-container-no-flexbox .swiper-slide[data-v-7fa4e2da]{float:left\n}\n.swiper-container-vertical>.swiper-wrapper[data-v-7fa4e2da]{-ms-flex-direction:column;flex-direction:column\n}\n.swiper-wrapper[data-v-7fa4e2da]{position:relative;width:100%;height:100%;z-index:1;display:-ms-flexbox;display:flex;transition-property:transform;box-sizing:content-box\n}\n.swiper-container-android .swiper-slide[data-v-7fa4e2da], .swiper-wrapper[data-v-7fa4e2da]{transform:translate3d(0,0,0)\n}\n.swiper-container-multirow>.swiper-wrapper[data-v-7fa4e2da]{-ms-flex-wrap:wrap;flex-wrap:wrap\n}\n.swiper-container-free-mode>.swiper-wrapper[data-v-7fa4e2da]{transition-timing-function:ease-out;margin:0 auto\n}\n.swiper-slide[data-v-7fa4e2da]{-ms-flex-negative:0;flex-shrink:0;width:100%;height:100%;position:relative;transition-property:transform\n}\n.swiper-slide-invisible-blank[data-v-7fa4e2da]{visibility:hidden\n}\n.swiper-container-autoheight[data-v-7fa4e2da], .swiper-container-autoheight .swiper-slide[data-v-7fa4e2da]{height:auto\n}\n.swiper-container-autoheight .swiper-wrapper[data-v-7fa4e2da]{-ms-flex-align:start;align-items:flex-start;transition-property:transform,height\n}\n.swiper-container-3d[data-v-7fa4e2da]{perspective:1200px\n}\n.swiper-container-3d .swiper-cube-shadow[data-v-7fa4e2da], .swiper-container-3d .swiper-slide[data-v-7fa4e2da], .swiper-container-3d .swiper-slide-shadow-bottom[data-v-7fa4e2da], .swiper-container-3d .swiper-slide-shadow-left[data-v-7fa4e2da], .swiper-container-3d .swiper-slide-shadow-right[data-v-7fa4e2da], .swiper-container-3d .swiper-slide-shadow-top[data-v-7fa4e2da], .swiper-container-3d .swiper-wrapper[data-v-7fa4e2da]{transform-style:preserve-3d\n}\n.swiper-container-3d .swiper-slide-shadow-bottom[data-v-7fa4e2da], .swiper-container-3d .swiper-slide-shadow-left[data-v-7fa4e2da], .swiper-container-3d .swiper-slide-shadow-right[data-v-7fa4e2da], .swiper-container-3d .swiper-slide-shadow-top[data-v-7fa4e2da]{position:absolute;left:0;top:0;width:100%;height:100%;pointer-events:none;z-index:10\n}\n.swiper-container-3d .swiper-slide-shadow-left[data-v-7fa4e2da]{background-image:linear-gradient(to left,rgba(0,0,0,.5)rgba(0,0,0,0))\n}\n.swiper-container-3d .swiper-slide-shadow-right[data-v-7fa4e2da]{background-image:linear-gradient(to right,rgba(0,0,0,.5)rgba(0,0,0,0))\n}\n.swiper-container-3d .swiper-slide-shadow-top[data-v-7fa4e2da]{background-image:linear-gradient(to top,rgba(0,0,0,.5)rgba(0,0,0,0))\n}\n.swiper-container-3d .swiper-slide-shadow-bottom[data-v-7fa4e2da]{background-image:linear-gradient(to bottom,rgba(0,0,0,.5)rgba(0,0,0,0))\n}\n.swiper-container-wp8-horizontal[data-v-7fa4e2da], .swiper-container-wp8-horizontal>.swiper-wrapper[data-v-7fa4e2da]{-ms-touch-action:pan-y;touch-action:pan-y\n}\n.swiper-container-wp8-vertical[data-v-7fa4e2da], .swiper-container-wp8-vertical>.swiper-wrapper[data-v-7fa4e2da]{-ms-touch-action:pan-x;touch-action:pan-x\n}\n.swiper-button-next[data-v-7fa4e2da], .swiper-button-prev[data-v-7fa4e2da]{position:absolute;top:50%;width:27px;height:44px;margin-top:-22px;z-index:10;cursor:pointer;background-size:27px 44px;background-position:center;background-repeat:no-repeat\n}\n.swiper-button-next.swiper-button-disabled[data-v-7fa4e2da], .swiper-button-prev.swiper-button-disabled[data-v-7fa4e2da]{opacity:.35;cursor:auto;pointer-events:none\n}\n.swiper-button-prev[data-v-7fa4e2da], .swiper-container-rtl .swiper-button-next[data-v-7fa4e2da]{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M0%2C22L22%2C0l2.1%2C2.1L4.2%2C22l19.9%2C19.9L22%2C44L0%2C22L0%2C22L0%2C22z'%20fill%3D'%23007aff'%2F%3E%3C%2Fsvg%3E\");left:10px;right:auto\n}\n.swiper-button-next[data-v-7fa4e2da], .swiper-container-rtl .swiper-button-prev[data-v-7fa4e2da]{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M27%2C22L27%2C22L5%2C44l-2.1-2.1L22.8%2C22L2.9%2C2.1L5%2C0L27%2C22L27%2C22z'%20fill%3D'%23007aff'%2F%3E%3C%2Fsvg%3E\");right:10px;left:auto\n}\n.swiper-button-prev.swiper-button-white[data-v-7fa4e2da], .swiper-container-rtl .swiper-button-next.swiper-button-white[data-v-7fa4e2da]{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M0%2C22L22%2C0l2.1%2C2.1L4.2%2C22l19.9%2C19.9L22%2C44L0%2C22L0%2C22L0%2C22z'%20fill%3D'%23ffffff'%2F%3E%3C%2Fsvg%3E\")\n}\n.swiper-button-next.swiper-button-white[data-v-7fa4e2da], .swiper-container-rtl .swiper-button-prev.swiper-button-white[data-v-7fa4e2da]{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M27%2C22L27%2C22L5%2C44l-2.1-2.1L22.8%2C22L2.9%2C2.1L5%2C0L27%2C22L27%2C22z'%20fill%3D'%23ffffff'%2F%3E%3C%2Fsvg%3E\")\n}\n.swiper-button-prev.swiper-button-black[data-v-7fa4e2da], .swiper-container-rtl .swiper-button-next.swiper-button-black[data-v-7fa4e2da]{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M0%2C22L22%2C0l2.1%2C2.1L4.2%2C22l19.9%2C19.9L22%2C44L0%2C22L0%2C22L0%2C22z'%20fill%3D'%23000000'%2F%3E%3C%2Fsvg%3E\")\n}\n.swiper-button-next.swiper-button-black[data-v-7fa4e2da], .swiper-container-rtl .swiper-button-prev.swiper-button-black[data-v-7fa4e2da]{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M27%2C22L27%2C22L5%2C44l-2.1-2.1L22.8%2C22L2.9%2C2.1L5%2C0L27%2C22L27%2C22z'%20fill%3D'%23000000'%2F%3E%3C%2Fsvg%3E\")\n}\n.swiper-button-lock[data-v-7fa4e2da]{display:none\n}\n.swiper-pagination[data-v-7fa4e2da]{position:absolute;text-align:center;transition:.3s opacity;transform:translate3d(0,0,0);z-index:10\n}\n.swiper-pagination.swiper-pagination-hidden[data-v-7fa4e2da]{opacity:0\n}\n.swiper-container-horizontal>.swiper-pagination-bullets[data-v-7fa4e2da], .swiper-pagination-custom[data-v-7fa4e2da], .swiper-pagination-fraction[data-v-7fa4e2da]{bottom:10px;left:0;width:100%\n}\n.swiper-pagination-bullets-dynamic[data-v-7fa4e2da]{overflow:hidden;font-size:0\n}\n.swiper-pagination-bullets-dynamic .swiper-pagination-bullet[data-v-7fa4e2da]{transform:scale(.33);position:relative\n}\n.swiper-pagination-bullets-dynamic .swiper-pagination-bullet-active[data-v-7fa4e2da]{transform:scale(1)\n}\n.swiper-pagination-bullets-dynamic .swiper-pagination-bullet-active-main[data-v-7fa4e2da]{transform:scale(1)\n}\n.swiper-pagination-bullets-dynamic .swiper-pagination-bullet-active-prev[data-v-7fa4e2da]{transform:scale(.66)\n}\n.swiper-pagination-bullets-dynamic .swiper-pagination-bullet-active-prev-prev[data-v-7fa4e2da]{transform:scale(.33)\n}\n.swiper-pagination-bullets-dynamic .swiper-pagination-bullet-active-next[data-v-7fa4e2da]{transform:scale(.66)\n}\n.swiper-pagination-bullets-dynamic .swiper-pagination-bullet-active-next-next[data-v-7fa4e2da]{transform:scale(.33)\n}\n.swiper-pagination-bullet[data-v-7fa4e2da]{width:8px;height:8px;display:inline-block;border-radius:100%;background:#000;opacity:.2\n}\nbutton.swiper-pagination-bullet[data-v-7fa4e2da]{border:none;margin:0;padding:0;box-shadow:none;-webkit-appearance:none;-moz-appearance:none;appearance:none\n}\n.swiper-pagination-clickable .swiper-pagination-bullet[data-v-7fa4e2da]{cursor:pointer\n}\n.swiper-pagination-bullet-active[data-v-7fa4e2da]{opacity:1;background:#007aff\n}\n.swiper-container-vertical>.swiper-pagination-bullets[data-v-7fa4e2da]{right:10px;top:50%;transform:translate3d(0,-50%,0)\n}\n.swiper-container-vertical>.swiper-pagination-bullets .swiper-pagination-bullet[data-v-7fa4e2da]{margin:6px 0;display:block\n}\n.swiper-container-vertical>.swiper-pagination-bullets.swiper-pagination-bullets-dynamic[data-v-7fa4e2da]{top:50%;transform:translateY(-50%);width:8px\n}\n.swiper-container-vertical>.swiper-pagination-bullets.swiper-pagination-bullets-dynamic .swiper-pagination-bullet[data-v-7fa4e2da]{display:inline-block;transition:.2s top,.2s -webkit-transform;transition:.2s transform,.2s top;transition:.2s transform,.2s top,.2s -webkit-transform\n}\n.swiper-container-horizontal>.swiper-pagination-bullets .swiper-pagination-bullet[data-v-7fa4e2da]{margin:0 4px\n}\n.swiper-container-horizontal>.swiper-pagination-bullets.swiper-pagination-bullets-dynamic[data-v-7fa4e2da]{left:50%;transform:translateX(-50%);white-space:nowrap\n}\n.swiper-container-horizontal>.swiper-pagination-bullets.swiper-pagination-bullets-dynamic .swiper-pagination-bullet[data-v-7fa4e2da]{transition:.2s left,.2s -webkit-transform;transition:.2s transform,.2s left;transition:.2s transform,.2s left,.2s -webkit-transform\n}\n.swiper-container-horizontal.swiper-container-rtl>.swiper-pagination-bullets-dynamic .swiper-pagination-bullet[data-v-7fa4e2da]{transition:.2s right,.2s -webkit-transform;transition:.2s transform,.2s right;transition:.2s transform,.2s right,.2s -webkit-transform\n}\n.swiper-pagination-progressbar[data-v-7fa4e2da]{background:rgba(0,0,0,.25);position:absolute\n}\n.swiper-pagination-progressbar .swiper-pagination-progressbar-fill[data-v-7fa4e2da]{background:#007aff;position:absolute;left:0;top:0;width:100%;height:100%;transform:scale(0);transform-origin:left top\n}\n.swiper-container-rtl .swiper-pagination-progressbar .swiper-pagination-progressbar-fill[data-v-7fa4e2da]{transform-origin:right top\n}\n.swiper-container-horizontal>.swiper-pagination-progressbar[data-v-7fa4e2da], .swiper-container-vertical>.swiper-pagination-progressbar.swiper-pagination-progressbar-opposite[data-v-7fa4e2da]{width:100%;height:4px;left:0;top:0\n}\n.swiper-container-horizontal>.swiper-pagination-progressbar.swiper-pagination-progressbar-opposite[data-v-7fa4e2da], .swiper-container-vertical>.swiper-pagination-progressbar[data-v-7fa4e2da]{width:4px;height:100%;left:0;top:0\n}\n.swiper-pagination-white .swiper-pagination-bullet-active[data-v-7fa4e2da]{background:#fff\n}\n.swiper-pagination-progressbar.swiper-pagination-white[data-v-7fa4e2da]{background:rgba(255,255,255,.25)\n}\n.swiper-pagination-progressbar.swiper-pagination-white .swiper-pagination-progressbar-fill[data-v-7fa4e2da]{background:#fff\n}\n.swiper-pagination-black .swiper-pagination-bullet-active[data-v-7fa4e2da]{background:#000\n}\n.swiper-pagination-progressbar.swiper-pagination-black[data-v-7fa4e2da]{background:rgba(0,0,0,.25)\n}\n.swiper-pagination-progressbar.swiper-pagination-black .swiper-pagination-progressbar-fill[data-v-7fa4e2da]{background:#000\n}\n.swiper-pagination-lock[data-v-7fa4e2da]{display:none\n}\n.swiper-scrollbar[data-v-7fa4e2da]{border-radius:10px;position:relative;-ms-touch-action:none;background:rgba(0,0,0,.1)\n}\n.swiper-container-horizontal>.swiper-scrollbar[data-v-7fa4e2da]{position:absolute;left:1%;bottom:3px;z-index:50;height:5px;width:98%\n}\n.swiper-container-vertical>.swiper-scrollbar[data-v-7fa4e2da]{position:absolute;right:3px;top:1%;z-index:50;width:5px;height:98%\n}\n.swiper-scrollbar-drag[data-v-7fa4e2da]{height:100%;width:100%;position:relative;background:rgba(0,0,0,.5);border-radius:10px;left:0;top:0\n}\n.swiper-scrollbar-cursor-drag[data-v-7fa4e2da]{cursor:move\n}\n.swiper-scrollbar-lock[data-v-7fa4e2da]{display:none\n}\n.swiper-zoom-container[data-v-7fa4e2da]{width:100%;height:100%;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;text-align:center\n}\n.swiper-zoom-container>canvas[data-v-7fa4e2da], .swiper-zoom-container>img[data-v-7fa4e2da], .swiper-zoom-container>svg[data-v-7fa4e2da]{max-width:100%;max-height:100%;-o-object-fit:contain;object-fit:contain\n}\n.swiper-slide-zoomed[data-v-7fa4e2da]{cursor:move\n}\n.swiper-lazy-preloader[data-v-7fa4e2da]{width:42px;height:42px;position:absolute;left:50%;top:50%;margin-left:-21px;margin-top:-21px;z-index:10;transform-origin:50%;animation:swiper-preloader-spin-data-v-7fa4e2da 1s steps(12,end) infinite\n}\n.swiper-lazy-preloader[data-v-7fa4e2da]:after{display:block;content:'';width:100%;height:100%;background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20viewBox%3D'0%200%20120%20120'%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20xmlns%3Axlink%3D'http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink'%3E%3Cdefs%3E%3Cline%20id%3D'l'%20x1%3D'60'%20x2%3D'60'%20y1%3D'7'%20y2%3D'27'%20stroke%3D'%236c6c6c'%20stroke-width%3D'11'%20stroke-linecap%3D'round'%2F%3E%3C%2Fdefs%3E%3Cg%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(30%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(60%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(90%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(120%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(150%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.37'%20transform%3D'rotate(180%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.46'%20transform%3D'rotate(210%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.56'%20transform%3D'rotate(240%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.66'%20transform%3D'rotate(270%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.75'%20transform%3D'rotate(300%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.85'%20transform%3D'rotate(330%2060%2C60)'%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E\");background-position:50%;background-size:100%;background-repeat:no-repeat\n}\n.swiper-lazy-preloader-white[data-v-7fa4e2da]:after{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20viewBox%3D'0%200%20120%20120'%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20xmlns%3Axlink%3D'http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink'%3E%3Cdefs%3E%3Cline%20id%3D'l'%20x1%3D'60'%20x2%3D'60'%20y1%3D'7'%20y2%3D'27'%20stroke%3D'%23fff'%20stroke-width%3D'11'%20stroke-linecap%3D'round'%2F%3E%3C%2Fdefs%3E%3Cg%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(30%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(60%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(90%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(120%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.27'%20transform%3D'rotate(150%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.37'%20transform%3D'rotate(180%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.46'%20transform%3D'rotate(210%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.56'%20transform%3D'rotate(240%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.66'%20transform%3D'rotate(270%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.75'%20transform%3D'rotate(300%2060%2C60)'%2F%3E%3Cuse%20xlink%3Ahref%3D'%23l'%20opacity%3D'.85'%20transform%3D'rotate(330%2060%2C60)'%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E\")\n}\n@keyframes swiper-preloader-spin-data-v-7fa4e2da{\n100%{transform:rotate(360deg)\n}\n}\n.swiper-container .swiper-notification[data-v-7fa4e2da]{position:absolute;left:0;top:0;pointer-events:none;opacity:0;z-index:-1000\n}\n.swiper-container-fade.swiper-container-free-mode .swiper-slide[data-v-7fa4e2da]{transition-timing-function:ease-out\n}\n.swiper-container-fade .swiper-slide[data-v-7fa4e2da]{pointer-events:none;transition-property:opacity\n}\n.swiper-container-fade .swiper-slide .swiper-slide[data-v-7fa4e2da]{pointer-events:none\n}\n.swiper-container-fade .swiper-slide-active[data-v-7fa4e2da], .swiper-container-fade .swiper-slide-active .swiper-slide-active[data-v-7fa4e2da]{pointer-events:auto\n}\n.swiper-container-cube[data-v-7fa4e2da]{overflow:visible\n}\n.swiper-container-cube .swiper-slide[data-v-7fa4e2da]{pointer-events:none;-webkit-backface-visibility:hidden;backface-visibility:hidden;z-index:1;visibility:hidden;transform-origin:0 0;width:100%;height:100%\n}\n.swiper-container-cube .swiper-slide .swiper-slide[data-v-7fa4e2da]{pointer-events:none\n}\n.swiper-container-cube.swiper-container-rtl .swiper-slide[data-v-7fa4e2da]{transform-origin:100% 0\n}\n.swiper-container-cube .swiper-slide-active[data-v-7fa4e2da], .swiper-container-cube .swiper-slide-active .swiper-slide-active[data-v-7fa4e2da]{pointer-events:auto\n}\n.swiper-container-cube .swiper-slide-active[data-v-7fa4e2da], .swiper-container-cube .swiper-slide-next[data-v-7fa4e2da], .swiper-container-cube .swiper-slide-next+.swiper-slide[data-v-7fa4e2da], .swiper-container-cube .swiper-slide-prev[data-v-7fa4e2da]{pointer-events:auto;visibility:visible\n}\n.swiper-container-cube .swiper-slide-shadow-bottom[data-v-7fa4e2da], .swiper-container-cube .swiper-slide-shadow-left[data-v-7fa4e2da], .swiper-container-cube .swiper-slide-shadow-right[data-v-7fa4e2da], .swiper-container-cube .swiper-slide-shadow-top[data-v-7fa4e2da]{z-index:0;-webkit-backface-visibility:hidden;backface-visibility:hidden\n}\n.swiper-container-cube .swiper-cube-shadow[data-v-7fa4e2da]{position:absolute;left:0;bottom:0;width:100%;height:100%;background:#000;opacity:.6;filter:blur(50px);z-index:0\n}\n.swiper-container-flip[data-v-7fa4e2da]{overflow:visible\n}\n.swiper-container-flip .swiper-slide[data-v-7fa4e2da]{pointer-events:none;-webkit-backface-visibility:hidden;backface-visibility:hidden;z-index:1\n}\n.swiper-container-flip .swiper-slide .swiper-slide[data-v-7fa4e2da]{pointer-events:none\n}\n.swiper-container-flip .swiper-slide-active[data-v-7fa4e2da], .swiper-container-flip .swiper-slide-active .swiper-slide-active[data-v-7fa4e2da]{pointer-events:auto\n}\n.swiper-container-flip .swiper-slide-shadow-bottom[data-v-7fa4e2da], .swiper-container-flip .swiper-slide-shadow-left[data-v-7fa4e2da], .swiper-container-flip .swiper-slide-shadow-right[data-v-7fa4e2da], .swiper-container-flip .swiper-slide-shadow-top[data-v-7fa4e2da]{z-index:0;-webkit-backface-visibility:hidden;backface-visibility:hidden\n}\n.swiper-container-coverflow .swiper-wrapper[data-v-7fa4e2da]{-ms-perspective:1200px\n}\n.wrap-swiper-nav .list-head[data-v-7fa4e2da] {\n  margin: 5px 0;\n  padding: 0 10px;\n  height: 18px;\n  line-height: 18px;\n  font-size: 14px;\n  font-weight: 700;\n}\n.wrap-swiper-nav .list-head > span[data-v-7fa4e2da] {\n  float: left;\n  margin-right: 5px;\n  width: 4px;\n  height: 100%;\n}\n.wrap-swiper-nav .swiper-slide[data-v-7fa4e2da] {\n  padding: 10px 0;\n  text-align: center;\n  font-size: 12px;\n}\n.wrap-swiper-nav .swiper-slide[data-v-7fa4e2da]:active {\n  background-color: #f4f4f4;\n}\n", ""]);
...
var render = function() {
  ...
  return _c("div", { staticClass: "wrap-swiper-nav swiper-container" }, [
    _vm.head
      ? _c("p", { staticClass: "list-head" }, [
          _c("span", { staticClass: "theme-b" }),
          _c("label", [_vm._v(_vm._s(_vm.head))])
        ])
      : _vm._e(),
    _c(
      "div",
      ...
      _vm._l(_vm.data, function(item) {
        return _c(
          ...
          [
            _c("img", {
              attrs: { width: "45px", height: "45px", src: item.img }
            }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7fa4e2da", { render: render, staticRenderFns: staticRenderFns })
  }
}
