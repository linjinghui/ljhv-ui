(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ComponentBaseUI"] = factory(require("jQuery"));
	else
		root["ComponentBaseUI"] = factory(root["jQuery"]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e7ec2ce4_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(232);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e7ec2ce4_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e7ec2ce4_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "packages\\tree\\src\\main.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e7ec2ce4", Component.options)
  } else {
    hotAPI.reload("data-v-e7ec2ce4", Component.options)
  }
...
var update = add("a5df05f8", content, false, {});
...
module.exports = __webpack_require__.p + "images/37b02ccfdb0b4f6ce3bf3ce10d1796f7.png";
...
(function (factory) {
	"use strict";
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(96)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
var render = function() {
  ...
  return _c(
    "vperfect-scrollbar",
    { staticClass: "scroll-area vtree", attrs: { settings: _vm.settings } },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e7ec2ce4", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
module.exports = __webpack_require__.p + "images/c5a5bf697ebf99eab983e336b4e2057d.png";
...
module.exports = __webpack_require__.p + "images/5e55c38fe2e0190f5aaa9f6bc250e428.gif";
...
module.exports = __webpack_require__.p + "images/24806793015f983316cdcf4ba3eb64da.png";
...
exports.default = {
  ...
  watch: {
    treeData: function treeData(val, val2) {
  ...
  methods: {
    getTreeDom: function getTreeDom() {
      return (0, _jquery2.default)('#tree');
    },
    initJstree: function initJstree(data) {
      var _this = this;
      ...
      if (data) {
        ...
        this.getTreeDom().on('select_node.jstree', function (e, data) {
          ...
          for (var i = parentIds.length - 1; i >= 0; i--) {
            if (parentIds[i] !== '#') {
              var id = parentIds[i];
              var parentNode = instance.get_node(id)['original'];
              var parentChild = instance.get_node(id)['children'];
          ...
          // 当前节点数据
          var current = data.node['original'];
          var currentChildrenData = _this.getChildrenById(data.node['id'], data.node['parent'] === '#');
    ...
    destroyJstree: function destroyJstree() {
    ...
    removeAHref: function removeAHref() {
      var _this = this;
    ...
    getChildrenById: function getChildrenById(id, isRoot) {
      var data = this.treeData[0];
      var result = false;
      var resultData = '';
      var searchFun = function searchFun(childrenArr) {
    ...
    getAllChecked: function getAllChecked() {
      var _this = this;
      var checkBoxes = this.getTreeDom().jstree().get_checked(true) || [];

      // 获取所有半选框
      if (this.undetermined) {
        this.getTreeDom().find('.jstree-undetermined').each(function (i, element) {
          var dom = (0, _jquery2.default)(element).parents('li');
          var id = dom.attr('id');
