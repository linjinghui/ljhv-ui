...
exports.default = {
  ...
  methods: {
    // 创建选择器代码
    creatMenu: function creatMenu(top, left) {
      var _this = this;
    ...
    insertMenu: function insertMenu(dom, menu, menuTop, menuLeft) {
...
Component.options.__file = "packages\\select\\src\\main.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1ee11b30", Component.options)
  } else {
    hotAPI.reload("data-v-1ee11b30", Component.options)
  }
...
var update = add("13461aa6", content, false, {});
...
// module
exports.push([module.i, "\n.wrap-select {\n  position: fixed;\n  top: 500px;\n  left: 500px;\n  padding: 5px 0;\n  width: 140px;\n  border: solid 1px #e4e7ed;\n  box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1);\n  border-radius: 4px;\n  background-color: #fff;\n  line-height: normal;\n  line-height: initial;\n  z-index: 5;\n}\n.wrap-select > li {\n    padding: 4px 10px;\n    display: -ms-flexbox;\n    display: flex;\n    -ms-flex-negative: 0;\n        flex-shrink: 0;\n    -ms-flex-align: center;\n        align-items: center;\n    cursor: pointer;\n}\n.wrap-select > li:hover {\n    background-color: #f5f7fa;\n}\n.wrap-select > .arrow {\n    position: fixed;\n    width: 0px;\n    height: 0px;\n    border: solid 8px transparent;\n    border-top: 0;\n    border-bottom-color: #999;\n}\n.wrap-select > .arrow:after {\n    content: '';\n    position: absolute;\n    left: -8px;\n    top: 0;\n    width: 0px;\n    height: 0px;\n    border: solid 8px transparent;\n    border-top: 0;\n    border-bottom-color: #fff;\n}\n", ""]);
