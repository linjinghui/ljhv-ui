...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0693c6a2_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(214);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0693c6a2_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0693c6a2_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "packages\\sidebar\\src\\main.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0693c6a2", Component.options)
  } else {
    hotAPI.reload("data-v-0693c6a2", Component.options)
  }
...
var update = add("46a46178", content, false, {});
...
var render = function() {
  ...
  return _c("transition", { attrs: { name: "slide-fade-sidebar" } }, [
    _vm.value !== ""
      ? _c(
          "div",
          {
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.value + "" === "true",
                expression: "(value + '' === 'true')"
              }
            ],
            staticClass: "wrap-aside",
            style: { "z-index": _vm.zIndex + 1 }
          },
          [
            _vm.$slots.title ? _c("header", [_vm._t("title")], 2) : _vm._e(),
            _c(
              "vperfect-scrollbar",
              {
                ...
                style: {
                  height:
                    "calc(100% - " +
                    (_vm.$slots.title ? 60 : 0) +
                    "px - " +
                    (_vm.$slots.footer ? 60 : 0) +
                    "px)"
                },
                attrs: { settings: _vm.settings },
                on: {
                  "ps-y-reach-end": function($event) {
                    return _vm.handle_scroll("end")
                  },
                  "ps-y-reach-start": function($event) {
                    return _vm.handle_scroll("top")
                  }
                }
              },
              [_vm._t("content")],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0693c6a2", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
exports.default = {
  ...
  methods: {
    ...
    emt_show: function emt_show(type) {
      this.$emit('input', type);
    },
    handle_scroll: function handle_scroll(type) {
