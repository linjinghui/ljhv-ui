...
exports.default = {
  name: 'Prompt',
  components: {
    lvDialog: _index2.default,
    lvInput: _index4.default
  },
  data: function data() {
    return {
      pshow: this.value,
  ...
  methods: {
    dlgCallback: function dlgCallback(data) {
...
var _prompt = __webpack_require__(308);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_prompt_vue__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e262779a_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_prompt_vue__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
  ...
  return _c(
    "lv-dialog",
    {
      attrs: {
        ...
        esc: _vm.esc,
        align: _vm.align,
        modalClick: _vm.modalClick,
        headText: _vm.headText,
        buttons: _vm.buttons
      },
      on: { callback: _vm.dlgCallback },
      model: {
        value: _vm.pshow,
        callback: function($$v) {
          _vm.pshow = $$v
