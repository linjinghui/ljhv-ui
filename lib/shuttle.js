...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_40f95865_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-40f95865"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_40f95865_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_40f95865_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "packages\\shuttle\\src\\main.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-40f95865", Component.options)
  } else {
    hotAPI.reload("data-v-40f95865", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("3d87a208", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-40f95865\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-40f95865\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.shuttle[data-v-40f95865] {\n  position: relative;\n  width: 100%;\n  height: 100%;\n}\n.shuttle > div[data-v-40f95865] {\n    float: left;\n    height: 100%;\n}\n.shuttle > .p-m[data-v-40f95865] {\n    position: relative;\n    width: 12%;\n}\n.shuttle > .p-m > .btn-wrap[data-v-40f95865] {\n      width: 100%;\n      height: 90px;\n}\n.shuttle > .p-m > .btn-wrap > .btn[data-v-40f95865] {\n        position: relative;\n        display: block;\n        margin: 0 auto;\n        padding: 0;\n        width: 40px;\n        height: 40px;\n        border-radius: 50%;\n        color: #fff;\n}\n.shuttle > .p-m > .btn-wrap > .btn > i[data-v-40f95865] {\n          font-size: 20px;\n}\n.shuttle > .p-m > .btn-wrap > .btn[disabled][data-v-40f95865] {\n        border: solid 1px;\n        color: #c0c4cc;\n        background-color: #f5f5f5 !important;\n}\n.shuttle > .p-m > .btn-wrap > .btn[data-v-40f95865]:first-of-type {\n        margin-bottom: 10px;\n}\n.shuttle > .p-list[data-v-40f95865] {\n    width: 44%;\n    border: 1px solid #ebebeb;\n    border-radius: 4px;\n    overflow: hidden;\n}\n.shuttle > .p-list > header[data-v-40f95865] {\n      padding: 0 14px;\n      height: 40px;\n      line-height: 40px;\n      font-size: 16px;\n      background-color: #f5f7fa;\n}\n.shuttle > .p-list > header > .checkbox[data-v-40f95865] {\n        margin-right: 0;\n        width: calc(100% - 50px);\n}\n.shuttle > .p-list > header > span[data-v-40f95865] {\n        float: right;\n        width: 50px;\n        height: 100%;\n        text-align: right;\n        font-size: 12px;\n        color: #939393;\n}\n.shuttle > .p-list > section[data-v-40f95865] {\n      height: calc(100% - 40px);\n      background-color: #fff;\n}\n.shuttle > .p-list > section > .line[data-v-40f95865] {\n        float: left;\n        display: block;\n        padding: 0 14px;\n        min-width: 100%;\n        height: 40px;\n        line-height: 40px;\n}\n.shuttle > .p-list > section > .line > .checkbox[data-v-40f95865] {\n          white-space: nowrap;\n}\n.shuttle > .p-list > section > .line[data-v-40f95865]:not(.disabled):hover {\n        background-color: #f5f5f5;\n}\n.shuttle > .p-list > section > .line.active[data-v-40f95865] {\n        color: var(--theme);\n}\n", ""]);
...
var render = function() {
  ...
  return _c("div", { staticClass: "shuttle" }, [
    _c(
      "div",
      { staticClass: "p-list" },
      [
        _c(
          ...
          [
            _c(
              "cmp-checkbox",
              {
                on: { click: _vm.clk_l_sltall },
                model: {
                  value: _vm.leftData.checked,
                  callback: function($$v) {
                    _vm.$set(_vm.leftData, "checked", $$v)
                  },
                  expression: "leftData.checked"
                }
              },
            ...
            _c("span", [
              _vm._v(
                "\n        " +
                  _vm._s(
                    _vm.leftData.checkedNum
                      ? _vm.leftData.checkedNum + "/" + _vm.leftData.effNum
                      : _vm.leftData.effNum
                  ) +
                  "\n      "
              )
        ...
        _c(
          ...
          [
            _vm._l(_vm.leftData.data, function(item, index) {
              return [
                _vm.leftData.data.length > 0 && typeof item === "object"
                  ? _c(
                      "a",
                      {
                        key: "l_" + index,
    ...
    _c("div", { staticClass: "p-m" }, [
      _c(
        "div",
        { staticClass: "btn-wrap center-hv" },
        [
          _c(
            "cmp-button",
            {
              staticClass: "btn",
              attrs: { disabled: _vm.rightData.checkedNum === 0 },
              on: { click: _vm.clk_l_arrow }
            },
          ...
          _c(
            ...
            {
              staticClass: "btn",
              attrs: { disabled: _vm.leftData.checkedNum === 0 },
              on: { click: _vm.clk_r_arrow }
            },
    ...
    _c(
      ...
      [
        _c(
          ...
          [
            _c(
              "cmp-checkbox",
              {
                on: { click: _vm.clk_r_sltall },
                model: {
                  value: _vm.rightData.checked,
                  callback: function($$v) {
                    _vm.$set(_vm.rightData, "checked", $$v)
                  },
                  expression: "rightData.checked"
                }
              },
            ...
            _c("span", [
              _vm._v(
                "\n        " +
                  _vm._s(
                    _vm.rightData.checkedNum
                      ? _vm.rightData.checkedNum + "/" + _vm.rightData.effNum
                      : _vm.rightData.effNum
                  ) +
                  "\n      "
              )
            ])
        ...
        _c(
          ...
          { attrs: { settings: _vm.settings } },
          [
            _vm._l(_vm.rightData.data, function(item, index) {
              return [
                _vm.rightData.data.length > 0
                  ? _c(
                      "a",
                      {
                        key: "r_" + index,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-40f95865", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_18776a09_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
exports.default = {
  ...
  methods: {
    ...
    clkCheck: function clkCheck(checked) {
...
// module
exports.push([module.i, "\n.checkbox[data-v-18776a09] {\n  display: inline-block;\n  line-height: 16px;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  overflow: hidden;\n  cursor: pointer;\n}\n.checkbox > .wrap-tick[data-v-18776a09] {\n    position: relative;\n    float: left;\n    margin-right: 5px;\n    width: 16px;\n    height: 16px;\n    line-height: unset;\n    border-radius: 2px;\n    border: solid 1px #ccc;\n}\n.checkbox > .wrap-tick > .cicon-tick[data-v-18776a09] {\n      position: absolute;\n      display: none;\n      top: 0;\n      right: 0;\n      bottom: 0;\n      left: 0;\n      margin: auto;\n      color: #fff;\n      font-size: 14px;\n}\n.checkbox.checked > .wrap-tick.theme-b[data-v-18776a09] {\n  border: 0;\n}\n.checkbox.checked .cicon-tick[data-v-18776a09] {\n  display: inherit;\n}\n.checkbox[required][data-v-18776a09] {\n  cursor: text;\n}\n.checkbox[required] > .wrap-tick[data-v-18776a09] {\n    background-color: #fff;\n}\n.checkbox[required] .cicon-tick[data-v-18776a09] {\n    color: #ccc;\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    "label",
    {
      ...
      attrs: { disabled: _vm.disabled, required: _vm.required },
      on: { click: _vm.clkCheck }
    },
    [
      _c(
        "span",
        {
          staticClass: "wrap-tick",
          class: { "theme-b": _vm.value && !_vm.required }
        },
        [_c("i", { staticClass: "cicon-tick" })]
      ),
      _vm._t("default")
    ],
    2
...
exports.default = {
  ...
  components: {
    ...
    'cmpCheckbox': _index2.default,
    'cmpButton': _index4.default
  },
  data: function data() {
    return {
      // 滚动速度，默认1
  ...
  methods: {
    ...
    callback: function callback(val) {
      ...
      setTimeout(function () {
        // 去除checked属性
        var leftData = _this.utlRemoveCheckAttr(_this.leftData.data);
        var rightData = _this.utlRemoveCheckAttr(_this.rightData.data);
    ...
    clk_l_sltall: function clk_l_sltall() {
      var _this = this;
      var data = this.utlSetCheckedAttr(this.leftData.data, this.leftData.checked);
    ...
    clk_l_item: function clk_l_item(item) {
      // 获取选中数量
      var num = this.utlGetCheckedNum(this.leftData.data);
    ...
    clk_r_sltall: function clk_r_sltall() {
      var _this = this;
      var data = this.utlSetCheckedAttr(this.rightData.data, this.rightData.checked);
    ...
    clk_r_item: function clk_r_item(item) {
      // 获取选中数量
      var num = this.utlGetCheckedNum(this.rightData.data);
    ...
    clk_l_arrow: function clk_l_arrow() {
      this.$nextTick(function () {
        var data = this.rightData.data;
        var selectArr = this.value;
        var rgxkey = 'null';
    ...
    clk_r_arrow: function clk_r_arrow() {
      this.$nextTick(function () {
        var arr = [];
        var data = this.leftData.data;
    ...
    // 根据选中的下标数组设置左右侧数据
    setDataBySelectArray: function setDataBySelectArray() {
      var rdata = [];

      this.$nextTick(function () {
        // 给初始数据添加checkd属性
        var data = this.utlAddCheckAttr(this.data);
        var selectArr = this.value;
    ...
    // 给data添加 checked属性
    utlAddCheckAttr: function utlAddCheckAttr(data) {
      var result = [];
      var rgxkey = '"' + this.keyId + '":';
    ...
    // 移除数组中无效的的数据
    utlRemoveInvalid: function utlRemoveInvalid(data) {
      var result = [];
      var rgxkey = '"' + this.placeholder + '"';
    ...
    // 给data移除 checked属性
    utlRemoveCheckAttr: function utlRemoveCheckAttr(data) {
      var result = [];
      var rgxkey = '"checked":(false|true)';
    ...
    // 设置data中的checked属性
    utlSetCheckedAttr: function utlSetCheckedAttr(data, checked) {
      var result = [];
      var rgxkey = '"checked":(false|true)';
      var rpkey = '"checked":' + checked;
    ...
    // 计算已勾选的数量
    utlGetCheckedNum: function utlGetCheckedNum(data) {
      var num = 0;
      var regExp = new RegExp('"checked":true', 'g');
    ...
    // 去除数组中重复的数据
    utlUnique: function utlUnique(arr) {
      var result = [];
      var hash = {};
