...
;!function(){
  ...
  //字符常量  layui-this
  ,MOD_NAME = 'laydate', ELEM = '.layui-laydate', THIS = 'theme-b', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'laydate-disabled', TIPS_OUT = '开始日期超出了结束日期<br>建议重新选择', LIMIT_YEAR = [100, 200000]
